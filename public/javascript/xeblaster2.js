...
function InitializeScene(div){
    ...
    while(document.xeblaster_items['diamonator_pool'].length < 30){
...
function animate() {
    if(document.xeblaster_settings['run']){
        ...
        $("#scorebar_red").css({top: 100-(parseInt(document.xeblaster_settings['red_score']).toString()) + "%"});
        ...
        if(r*sm>(1.-document.xeblaster_settings['xe_spawn_chance']))
